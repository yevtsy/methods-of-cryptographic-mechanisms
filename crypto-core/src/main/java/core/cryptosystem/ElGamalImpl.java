...
public class ElGamalImpl implements ElGamal{
     ...
     * </ul>
     *
     * @see #ElGamalImpl(PublicKey, PrivateKey)
     * @see #generateKeyPair(String, java.math.BigInteger)
     * @see PrivateKey
     */
     ...
     *
     * @see #encrypt(String, java.math.BigInteger)
     * @see #decrypt(String, core.cryptosystem.ElGamalImpl.Ciphertext)
     */
     ...
     * @see #verify(String, core.cryptosystem.ElGamalImpl.Signature, String)
     */
     ...
     */
    public ElGamalImpl(final BigInteger p) {
        generateKeyPair("ElGamal", p);
    }
     ...
     */
    public ElGamalImpl(final PublicKey publicKey, final PrivateKey privateKey) {
     ...
     */
    @Override
    public void generateKeyPair(String algorithm, final BigInteger p) {
        if (!PrimeTest.MillerRabin(p)) throw new IllegalArgumentException("p should be prime");
     ...
     */
    @Override
    public Ciphertext encrypt(String algorithm, final BigInteger m) {
     ...
     */
    @Override
    public BigInteger decrypt(String algorithm, final Ciphertext c) {
        if (publicKey == null) throw new NullPointerException("Public key is not set");
     ...
     */
    @Override
    public Signature sign(String algorithm, String m) {
        if (publicKey == null) throw new NullPointerException("Public key is not set");
        if (privateKey == null) throw new NullPointerException("Private key is not set");
     ...
     */
    @Override
    public boolean verify(String algorithm, final Signature signature, String m) {
        if (publicKey == null) throw new NullPointerException("Public key is not set");
